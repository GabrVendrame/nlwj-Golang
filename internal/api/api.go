...
func (api *API) PatchParticipantsParticipantIDConfirm(w http.ResponseWriter, r *http.Request, participantID string) *spec.Response {
	...
	if err != nil {
		...
		return spec.PatchParticipantsParticipantIDConfirmJSON400Response(spec.Error{Message: "Somenthin went wrong"})
	}
	...
	if err := api.db.ConfirmParticipant(r.Context(), id); err != nil {
